...
class Game(object):
	...
	def display_frame(self, screen):
		...
		if self.game_over:
			...
			center_x = (screen_width//2)-(text.get_width()//2)  #posicion en x
			center_y = (screen_height//2) -(text.get_height()//2)  #posicion en y
			screen.blit(text,[center_x,center_y]) #pintarlo en pantallla
